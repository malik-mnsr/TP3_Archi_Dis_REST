...
@RestController
@RequestMapping("/agencyBooking/api")
public class AgencyReservationController {
    ...
    public ResponseEntity<Reservation> reserve(
            ...
            @RequestParam int chambreId) {

        try {
            Reservation reservation = agencyReservationService.makeReservation(name, startDate, endDate, offerId, 3);
